...
<section class="section">
      <div class="container mt-5">
        <div class="row">
          <div class="col-12 col-sm-8 offset-sm-2 col-md-6 offset-md-3 col-lg-6 offset-lg-3 col-xl-4 offset-xl-4">
            <div class="login-brand">
              ...
              <h1 class="text-success">IKSASS<span class="text-primary">JABAR</span></h1>
            </div>

            <div class="card card-primary">
              <div class="card-header"><h4>Login IKSASS</h4></div>
              <div class="card-body">
       ...
       <div class="alert alert-danger alert-dismissible show fade">
                ...
                <form method="POST"
        action="{{ route('login.post') }}" class="needs-validation" novalidate="">
    @csrf
    ...
    <div class="form-group">
        ...
        <input id="password" type="password" class="form-control @error('password') is-invalid @enderror"
            name="password" tabindex="2" required oninput="toggleShowPasswordButton('password')">
        <button type="button" id="showPassword" class="btn badge badge-light  toggle-password mt-2"
            style="display: none;" onclick="togglePasswordVisibility('password')"><i class="fas fa-eye"></i></button>
    </div>
