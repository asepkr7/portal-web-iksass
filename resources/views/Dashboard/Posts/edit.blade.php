    ...
    <div class="section">
        <div class="section-header">
            ...
            <div class="section-header-back">
                <a href="/petugas/data-pegawai/create" class="btn btn-icon btn-primary" title="Add Data Pegawai"><i
                        ...
                        <form action="{{ route('dashboard.posts.update', $post->slug) }}" method="POST"
                            ...
                            <div class="form-group
                                ...
                                <div class="form-group row mb-4">
                                    ...
                                    <div class="col-sm-12 col-md-7">
                                        <textarea name="content" class="summernote-simple  @error('content') is-invalid @enderror"
